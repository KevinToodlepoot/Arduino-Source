...
#include "PokemonSV_TeraSelfFarmerAdvanced.h"
...
TeraSelfFarmerAdvanced_Descriptor::TeraSelfFarmerAdvanced_Descriptor()
    : SingleSwitchProgramDescriptor(
        "PokemonSV:TeraSelfFarmerAdvanced",
        STRING_POKEMON + " SV", "Tera Self Farmer Advanced",
        "ComputerControl/blob/master/Wiki/Programs/PokemonSV/TeraSelfFarmerAdvanced.md",
...
{}
struct TeraSelfFarmerAdvanced_Descriptor::Stats : public StatsTracker{
    Stats()
...
std::unique_ptr<StatsTracker> TeraSelfFarmerAdvanced_Descriptor::make_stats() const{
    return std::unique_ptr<StatsTracker>(new Stats());
}



TeraFarmerAdvancedStopConditions::TeraFarmerAdvancedStopConditions()
...
TeraSelfFarmerAdvanced::~TeraSelfFarmerAdvanced(){
...
void TeraSelfFarmerAdvanced::value_changed(void* object){
...
bool TeraSelfFarmerAdvanced::run_raid(SingleSwitchProgramEnvironment& env, BotBaseContext& context){
    env.console.log("Running raid...");

    TeraSelfFarmerAdvanced_Descriptor::Stats& stats = env.current_stats<TeraSelfFarmerAdvanced_Descriptor::Stats>();
...
void TeraSelfFarmerAdvanced::program(SingleSwitchProgramEnvironment& env, BotBaseContext& context){
